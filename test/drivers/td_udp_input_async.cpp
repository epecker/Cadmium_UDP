...
#include "atomic_models/UDP_Input_Async.hpp"
...
int main(int argc, char* argv[]) {
	...
	do {
		...
		std::shared_ptr<dynamic::modeling::model> ir_message =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_LP, TIME, const char* >("ir_message", std::move(input_file_message.c_str()));
